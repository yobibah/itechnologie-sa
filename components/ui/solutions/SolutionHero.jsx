...
export default function SolutionHero({ title, tagline, image, imageAlt }) {
  return (
    <section className="mt-10 w-full px-3 py-3 sm:pt-10 sm:px-4 sm:py-4 md:pt-10 lg:pt-10 lg:px-66">
      <div
        className="
                    relative
                    aspect-[16/9]
