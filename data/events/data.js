import ccna from '../../public/images/events/cnna.jpeg';
import cybsec from '../../public/images/events/cybsecur.jpg';
import res from '../../public/images/events/reseaux.jpg';  
  
  const events = [
    {
      name: "FORMATION EN CNNA",
      desc: "Formation spécialisée destinée au renforcement des compétences techniques dans le domaine des réseaux et des infrastructures informatiques.",
      image: ccna,
    },
    {
